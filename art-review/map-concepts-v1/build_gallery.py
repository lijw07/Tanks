...
d.text((34,72),'Six editable Blender scenes  ·  Wooden tabletop collection',font=small,fill='#acb8b8')
...
print('Gallery and comparison sheet created')
